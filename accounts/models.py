...
class CustomUser(AbstractUser):
    ...
    restaurant = models.ForeignKey(Restaurant, null=True, blank=True, on_delete=models.SET_NULL, related_name='users')
    
    # For DM role (and optionally superuser if needed), allow multiple restaurants.
    restaurants = models.ManyToManyField(Restaurant, blank=True, related_name='district_managers')
